...
class Login:
    def __init__(self, root):
        ...
        #SubmitButton
        forget = Button(Frame_login, text="forgot password?", bd=0, cursor="hand2", fg="black", bg="white").place(x=30, y=300), 
        submit = Button(Frame_login,command=self.check_function, cursor="hand2", text="Submit", bg="black", fg="white").place(x=30, y=350)
